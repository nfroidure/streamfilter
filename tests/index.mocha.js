...
describe('StreamFilter', () => {
  ...
  describe('should fail', () => {
    ...
    it('if options.filter is not a function', () => {
      assert.throws(() => {
    ...
    describe('for ' + version + ' streams', () => {
      ...
      describe('in object mode', () => {
        ...
        describe('should work', () => {
          ...
          it('with no restore option', (done) => {
            const inputStream = StreamTest[version].fromObjects([object1, object2]);
            const filter = new StreamFilter((obj, unused, cb) => {
              if(obj === object2) {
                return cb(true);
              }
              return cb(false);
          ...
          it('with restore option', (done) => {
            ...
            const outputStream = StreamTest[version].toObjects((err, objs) => {
              ...
              assert.deepEqual(objs, [object1]);
              filter.restore.pipe(StreamTest[version].toObjects((err2, objs2) => {
                if(err2) {
                  done(err2);
                  return;
                }
          ...
          it('with restore and passthrough option in a different pipeline', (done) => {
            ...
            const restoreInputStream = StreamTest[version].fromObjects([object3]);
          ...
          it('with restore and passthrough option in the same pipeline', (done) => {
            ...
            const inputStream = StreamTest[version].fromObjects([object1, object2, object3]);
      ...
      describe('in buffer mode', () => {
        ...
        describe('should work', () => {
          ...
          it('with no restore option', (done) => {
            const inputStream = StreamTest[version].fromChunks([buffer1, buffer2]);
            const filter = new StreamFilter((chunk, encoding, cb) => {
          ...
          it('with restore option', (done) => {
            ...
            const outputStream = StreamTest[version].toText((err, text) => {
              ...
              filter.restore.pipe(StreamTest[version].toText((err2, text2) => {
                if(err2) {
                  done(err2);
                  return;
                }
          ...
          it('with restore and passthrough option', (done) => {
            ...
            const restoreInputStream = StreamTest[version].fromChunks([buffer3]);
